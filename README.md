...
## Notebooks
• [00_pull_merge](code/00_pull_merge) loads the raw input files (RAIS jobs, IBGE census, OD survey, zone crosswalk), builds job_housing_ratio and jobs_accessible_40min, and merges everything into model_df for the analyze notebook.
